...
export function CreateBoardButton() {
  ...
  return (
    <button
      ...
      className="group flex h-36 cursor-pointer flex-col items-start justify-between rounded-2xl border border-zinc-900 bg-zinc-900 p-5 text-left text-white shadow-sm ring-0 ring-emerald-500/0 transition-all hover:-translate-y-0.5 hover:bg-zinc-800 hover:shadow-lg hover:shadow-emerald-500/10 hover:ring-4 hover:ring-emerald-500/25 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-emerald-500/40 disabled:opacity-60 sm:h-40 sm:p-6 dark:border-zinc-200 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-white dark:hover:shadow-emerald-400/15 dark:hover:ring-emerald-400/30 dark:focus-visible:ring-emerald-400/50"
    >
...
export function OpenBoardForm() {
  ...
  return (
    <div className="flex h-36 cursor-default flex-col items-start justify-between rounded-2xl border border-zinc-200 bg-white p-5 text-left shadow-sm ring-0 ring-sky-500/0 transition-all hover:-translate-y-0.5 hover:border-sky-200 hover:shadow-lg hover:shadow-sky-500/10 hover:ring-4 hover:ring-sky-500/15 sm:h-40 sm:p-6 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-sky-400/30 dark:hover:shadow-sky-400/10 dark:hover:ring-sky-400/20">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="text-base font-semibold leading-tight sm:text-lg">Open existing board</p>
      ...
      <form onSubmit={handleSubmit} className="flex w-full items-stretch gap-2.5">
        ...
        <button
          type="submit"
          className="group/btn inline-flex h-11 shrink-0 cursor-pointer items-center justify-center gap-1.5 rounded-full bg-zinc-900 px-4 text-sm font-semibold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-zinc-700 hover:shadow-md focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-zinc-900/30 sm:px-6 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200 dark:focus-visible:ring-zinc-50/30"
        >
          Enter
